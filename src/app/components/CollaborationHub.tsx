...
export default function CollaborationHub() {
  ...
  const sendCollaboration = () => {
    if (selectedProjectForCollab && user) {
      ...
      sendCollaborationRequest(
        ...
        user.id, // business user ID (sender)
  ...
  // Only show collaboration hub to business users
      ...
      <div className="container mx-auto py-8">
        <div className="bg-white rounded-lg shadow-md p-6 text-center">
          ...
          <p className="text-gray-600">
            The collaboration hub is only available for business professionals.
          </p>
          <p className="text-gray-500 mt-2">
            As a student, you can manage your projects in the Seller Dashboard.
          </p>
        </div>
      </div>
    );
            ...
            {Object.keys(conversations).map(participantId => {
              ...
              return (
                <div 
                  ...
                  onClick={() => startChat(participantId, "Student Inventor")}
                >
                  <div>
                    <div className="flex justify-between">
                      <span className="font-medium">Student Inventor</span>
                    </div>
